...
HD_PWD='C:/Users/Yousef Jarrar/Documents/GitHub/CSE401/Labs/CSE401_Lab_Project-master/CSE401_Lab_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ifetch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ifetch.tcl -notrace
