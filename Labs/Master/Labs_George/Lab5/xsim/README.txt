...
#
# Generated by export_simulation on Wed Nov 14 13:14:01 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './writeback_tb.sh' script.

./writeback_tb.sh -reset_run
...
./writeback_tb.sh -noclean_files

For more information on the script, please type './writeback_tb.sh -help'.
