...
#
# Generated by export_simulation on Wed Oct 17 16:46:57 -0700 2018
#
################################################################################
...
'-reset_run' switch to the './pipeline.sh' script.

./pipeline.sh -reset_run
...
./pipeline.sh -noclean_files

For more information on the script, please type './pipeline.sh -help'.
