...
#
# Generated by export_simulation on Wed Nov 07 13:14:25 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './mem_test.sh' script.

./mem_test.sh -reset_run
...
./mem_test.sh -noclean_files

For more information on the script, please type './mem_test.sh -help'.
